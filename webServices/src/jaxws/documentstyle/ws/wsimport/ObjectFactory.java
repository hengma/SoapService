 ...
 * generated in the jaxws.documentstyle.ws.wsimport package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorldAsString_QNAME = new QName("http://ws.documentstyle.jaxws/", "getHelloWorldAsString");
    private final static QName _GetHelloWorldAsStringResponse_QNAME = new QName("http://ws.documentstyle.jaxws/", "getHelloWorldAsStringResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jaxws.documentstyle.ws.wsimport
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.documentstyle.jaxws/", name = "getHelloWorldAsString")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.documentstyle.jaxws/", name = "getHelloWorldAsStringResponse")
