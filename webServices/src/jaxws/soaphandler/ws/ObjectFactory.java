 ...
 * generated in the jaxws.soaphandler.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetServerName_QNAME = new QName("http://ws.soaphandler.jaxws/", "getServerName");
    private final static QName _GetServerNameResponse_QNAME = new QName("http://ws.soaphandler.jaxws/", "getServerNameResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jaxws.soaphandler.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.soaphandler.jaxws/", name = "getServerName")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.soaphandler.jaxws/", name = "getServerNameResponse")
